...
- 删除maven项目模版的文件  
pom.xml 文件修改 `dependencies` 清空,`<name></name>`填写`${project.artifactId}`,parent的version属性填写`${revision}`统一管理版本
...
### 4. 添加服务名常量和枚举
1. 在[AppConstant.java](bm-common/bm-base/src/main/java/org/github/bm/base/constant/AppConstant.java) 新增常量
    ```java
        /**
         * 演示使用模块名称
         */
    ...
    ```
2. 在[ServiceEnum.java](bm-common/bm-base/src/main/java/org/github/bm/base/constant/ServiceEnum.java) 新增枚举
    ```java
    /**
     * 演示模块枚举
     */
