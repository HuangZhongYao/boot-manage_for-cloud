...
import org.github.bm.system.feign.fallback.NotificationsRecordClientFallback;
 ...
 */
@FeignClient(value = AppConstant.APPLICATION_SYSTEM_NAME, contextId = "notificationsRecordClient", fallback = NotificationsRecordClientFallback.class)
public interface INotificationsRecordClient extends BaseFeign {

    /**
     * API基础路径前缀
     */
    String API_PREFIX = BASE_API_PREFIX + "/notificationsRecord";
